...
<html>
  ...
  <body>
    <div id="wrapper">
      ...
      <div id="gymBody" style="display: flex; justify-content: center;"><%-- 3/13 中央揃え修正（高橋） display以下追加 --%>
        <html:form action="/kihonShiftRegist" >
          <%-- 凡例 --%>
          <div id="hanrei" style="width:476px; margin-left:0px; float:left"><%--　3/13 中央揃え修正（高橋） margin-left:80→0px --%>
            <div>
